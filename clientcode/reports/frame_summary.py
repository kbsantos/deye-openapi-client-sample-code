...
def display_date_range_summary(summary, start_date, end_date):
    ...
    print(f"First Record:      {first_record or 'N/A'}")
    print(f"Last Record:       {last_record or 'N/A'}")
    print(f"")
    print(f"Production (kW):")
    print(f"  Average:         {avg_prod or 0:>8.2f}")
    print(f"  Maximum:         {max_prod or 0:>8.2f}")
    print(f"")
    print(f"Consumption (kW):")
    print(f"  Average:         {avg_cons or 0:>8.2f}")
    print(f"  Maximum:         {max_cons or 0:>8.2f}")
    print(f"")
    print(f"Grid Power (kW):   {avg_grid or 0:>8.2f}")
    print(f"Battery Power (kW): {avg_batt or 0:>8.2f}")
    print(f"")
    print(f"Battery SOC (%):")
    print(f"  Average:         {avg_soc or 0:>8.1f}")
    print(f"  Maximum:         {max_soc or 0:>8.1f}")
